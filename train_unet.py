...
if __name__ == '__main__':
    ...
    img_names = [path.name for path in Path(DIR_IMG).glob('*.jpg')] + [path.name for path in
                                                                       Path(DIR_IMG).glob('*.png')]
    mask_names = [path.name for path in Path(DIR_MASK).glob('*.jpg')] + [path.name for path in
                                                                         Path(DIR_MASK).glob('*.png')]
